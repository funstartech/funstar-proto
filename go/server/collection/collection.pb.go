...
const (
	...
	CollectionProductLevel_PRODUCT_LEVEL_NORMAL  CollectionProductLevel = 100 // 普通款
	CollectionProductLevel_PRODUCT_LEVEL_HIDDEN  CollectionProductLevel = 200 // 隐藏款
	CollectionProductLevel_PRODUCT_LEVEL_RARE    CollectionProductLevel = 300 // 稀有款
	CollectionProductLevel_PRODUCT_LEVEL_ULTRA   CollectionProductLevel = 400 // 欧皇款
	CollectionProductLevel_PRODUCT_LEVEL_LEGEND  CollectionProductLevel = 500 // 超神款
)
...
var (
	CollectionProductLevel_name = map[int32]string{
		...
		100: "PRODUCT_LEVEL_NORMAL",
		200: "PRODUCT_LEVEL_HIDDEN",
		300: "PRODUCT_LEVEL_RARE",
		400: "PRODUCT_LEVEL_ULTRA",
		500: "PRODUCT_LEVEL_LEGEND",
	}
	CollectionProductLevel_value = map[string]int32{
		"PRODUCT_LEVEL_UNKNOWN": 0,
		"PRODUCT_LEVEL_NORMAL":  100,
		"PRODUCT_LEVEL_HIDDEN":  200,
		"PRODUCT_LEVEL_RARE":    300,
		"PRODUCT_LEVEL_ULTRA":   400,
		"PRODUCT_LEVEL_LEGEND":  500,
	}
)
...
type CollectionDetailProducts struct {
	...
	Probability  float32                 `protobuf:"fixed32,2,opt,name=probability,proto3" json:"probability,omitempty"` // 层级概率
	Products     []*product.ProductBasic `protobuf:"bytes,3,rep,name=products,proto3" json:"products,omitempty"`
	ProductProbs []float32               `protobuf:"fixed32,4,rep,packed,name=product_probs,json=productProbs,proto3" json:"product_probs,omitempty"` // 商品在层级中的概率
}
...
func (x *CollectionDetailProducts) GetProductProbs() []float32 {
	if x != nil {
		return x.ProductProbs
	}
	return nil
}
...
type CollectionOnline struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TotalCount uint32   `protobuf:"varint,1,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"` // 总人数
	Avatars    []string `protobuf:"bytes,2,rep,name=avatars,proto3" json:"avatars,omitempty"`                          // 头像列表
}

func (x *CollectionOnline) Reset() {
	*x = CollectionOnline{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollectionOnline) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectionOnline) ProtoMessage() {}

func (x *CollectionOnline) ProtoReflect() protoreflect.Message {
	mi := &file_collection_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectionOnline.ProtoReflect.Descriptor instead.
func (*CollectionOnline) Descriptor() ([]byte, []int) {
	return file_collection_proto_rawDescGZIP(), []int{6}
}

func (x *CollectionOnline) GetTotalCount() uint32 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
func (x *CollectionOnline) GetAvatars() []string {
	if x != nil {
		return x.Avatars
	}
	return nil
...
type GetCollectionDetailRsp struct {
	...
	Online *CollectionOnline `protobuf:"bytes,3,opt,name=online,proto3" json:"online,omitempty"` // 当前在线
}
...
func (x *GetCollectionDetailRsp) GetOnline() *CollectionOnline {
	if x != nil {
		return x.Online
	}
	return nil
...
var file_collection_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x22, 0xb9, 0x01, 0x0a, 0x18, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f,
	...
	0x08, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x6f,
	0x64, 0x75, 0x63, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x62, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x02,
	0x52, 0x0c, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x50, 0x72, 0x6f, 0x62, 0x73, 0x22, 0x82,
	0x01, 0x0a, 0x10, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x74,
	0x61, 0x69, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x63, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x63, 0x69, 0x64, 0x12, 0x5c, 0x0a, 0x0f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x5f,
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x33,
	...
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x50, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x73, 0x52, 0x0e, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x50, 0x72, 0x6f, 0x64, 0x75,
	0x63, 0x74, 0x73, 0x22, 0x2e, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x12, 0x16, 0x0a, 0x06, 0x63,
	0x6f, 0x6f, 0x6b, 0x69, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x63, 0x6f, 0x6f,
	0x6b, 0x69, 0x65, 0x22, 0x93, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6c, 0x6c, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x73, 0x70, 0x12, 0x4c, 0x0a, 0x0b,
	...
	0x65, 0x72, 0x2e, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x43, 0x6f,
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x61, 0x73, 0x69, 0x63, 0x52, 0x0b, 0x63,
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x6f,
	...
	0x28, 0x08, 0x52, 0x05, 0x69, 0x73, 0x45, 0x6e, 0x64, 0x22, 0x2a, 0x0a, 0x16, 0x47, 0x65, 0x74,
	...
	,
	...
	,
	...
	0x73, 0x22, 0x40, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x48,
	...
	0x6b, 0x69, 0x65, 0x22, 0x8a, 0x01, 0x0a, 0x0e, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x48,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x35, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x01,
	...
	0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x31, 0x0a,
	...
	0x22, 0x8a, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x48,
	0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x73, 0x70, 0x12, 0x43, 0x0a, 0x07, 0x68, 0x69, 0x73,
	0x74, 0x6f, 0x72, 0x79, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x66, 0x75, 0x6e,
	0x73, 0x74, 0x61, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x63, 0x6f, 0x6c, 0x6c,
	0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4c, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x48, 0x69,
	...
	,
	...
	0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x2f,
	0x2e, 0x66, 0x75, 0x6e, 0x73, 0x74, 0x61, 0x72, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e,
	...
	,
	...
	,
	...
	0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
...
var file_collection_proto_goTypes = []interface{}{
	...
	(*CollectionOnline)(nil),           // 7: funstar.server.collection.CollectionOnline
	(*GetCollectionDetailRsp)(nil),     // 8: funstar.server.collection.GetCollectionDetailRsp
	(*BatchGetCollectionBasicReq)(nil), // 9: funstar.server.collection.BatchGetCollectionBasicReq
	(*BatchGetCollectionBasicRsp)(nil), // 10: funstar.server.collection.BatchGetCollectionBasicRsp
	(*LotteryReq)(nil),                 // 11: funstar.server.collection.LotteryReq
	(*LotteryRsp)(nil),                 // 12: funstar.server.collection.LotteryRsp
	(*GetLotteryHistoryReq)(nil),       // 13: funstar.server.collection.GetLotteryHistoryReq
	(*LotteryHistory)(nil),             // 14: funstar.server.collection.LotteryHistory
	(*GetLotteryHistoryRsp)(nil),       // 15: funstar.server.collection.GetLotteryHistoryRsp
	(*product.ProductBasic)(nil),       // 16: funstar.server.product.ProductBasic
	(*common.Collection)(nil),          // 17: funstar.common.Collection
	(*userinfo.UserInfo)(nil),          // 18: funstar.server.userinfo.UserInfo
	(*common.Product)(nil),             // 19: funstar.common.Product
}
var file_collection_proto_depIdxs = []int32{
	16, // 0: funstar.server.collection.CollectionDetailProducts.products:type_name -> funstar.server.product.ProductBasic
	...
	7,  // 5: funstar.server.collection.GetCollectionDetailRsp.online:type_name -> funstar.server.collection.CollectionOnline
	1,  // 6: funstar.server.collection.BatchGetCollectionBasicRsp.collections:type_name -> funstar.server.collection.CollectionBasic
	17, // 7: funstar.server.collection.LotteryReq.collections:type_name -> funstar.common.Collection
	17, // 8: funstar.server.collection.LotteryRsp.collections:type_name -> funstar.common.Collection
	18, // 9: funstar.server.collection.LotteryHistory.user:type_name -> funstar.server.userinfo.UserInfo
	19, // 10: funstar.server.collection.LotteryHistory.product:type_name -> funstar.common.Product
	14, // 11: funstar.server.collection.GetLotteryHistoryRsp.history:type_name -> funstar.server.collection.LotteryHistory
	4,  // 12: funstar.server.collection.CollectionSvr.GetCollectionList:input_type -> funstar.server.collection.GetCollectionListReq
	9,  // 13: funstar.server.collection.CollectionSvr.BatchGetCollectionBasic:input_type -> funstar.server.collection.BatchGetCollectionBasicReq
	6,  // 14: funstar.server.collection.CollectionSvr.GetCollectionDetail:input_type -> funstar.server.collection.GetCollectionDetailReq
	11, // 15: funstar.server.collection.CollectionSvr.Lottery:input_type -> funstar.server.collection.LotteryReq
	13, // 16: funstar.server.collection.CollectionSvr.GetLotteryHistory:input_type -> funstar.server.collection.GetLotteryHistoryReq
	5,  // 17: funstar.server.collection.CollectionSvr.GetCollectionList:output_type -> funstar.server.collection.GetCollectionListRsp
	10, // 18: funstar.server.collection.CollectionSvr.BatchGetCollectionBasic:output_type -> funstar.server.collection.BatchGetCollectionBasicRsp
	8,  // 19: funstar.server.collection.CollectionSvr.GetCollectionDetail:output_type -> funstar.server.collection.GetCollectionDetailRsp
	12, // 20: funstar.server.collection.CollectionSvr.Lottery:output_type -> funstar.server.collection.LotteryRsp
	15, // 21: funstar.server.collection.CollectionSvr.GetLotteryHistory:output_type -> funstar.server.collection.GetLotteryHistoryRsp
