...
type CreateTodoRsp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *CreateTodoRsp) Reset() {
	*x = CreateTodoRsp{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateTodoRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateTodoRsp) ProtoMessage() {}

func (x *CreateTodoRsp) ProtoReflect() protoreflect.Message {
	mi := &file_proto_todo_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateTodoRsp.ProtoReflect.Descriptor instead.
func (*CreateTodoRsp) Descriptor() ([]byte, []int) {
...
var file_proto_todo_proto_rawDesc = []byte{
	...
	,
...
var file_proto_todo_proto_goTypes = []interface{}{
	(*CreateTodoReq)(nil), // 0: funstar.server.todo.CreateTodoReq
	(*CreateTodoRsp)(nil), // 1: funstar.server.todo.CreateTodoRsp
}
var file_proto_todo_proto_depIdxs = []int32{
	0, // 0: funstar.server.todo.TodoSvr.CreateTodo:input_type -> funstar.server.todo.CreateTodoReq
	1, // 1: funstar.server.todo.TodoSvr.CreateTodo:output_type -> funstar.server.todo.CreateTodoRsp
