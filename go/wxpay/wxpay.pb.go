...
const (
	TradeState_TRADE_STATE_SUCCESS    TradeState = 0
	TradeState_TRADE_STATE_REFUND     TradeState = 1
	TradeState_TRADE_STATE_NOTPAY     TradeState = 2
	TradeState_TRADE_STATE_CLOSED     TradeState = 3
	TradeState_TRADE_STATE_REVOKED    TradeState = 4
	TradeState_TRADE_STATE_USERPAYING TradeState = 5
	TradeState_TRADE_STATE_PAYERROR   TradeState = 6
)

// Enum value maps for TradeState.
var (
	TradeState_name = map[int32]string{
		0: "TRADE_STATE_SUCCESS",
		1: "TRADE_STATE_REFUND",
		2: "TRADE_STATE_NOTPAY",
		3: "TRADE_STATE_CLOSED",
		4: "TRADE_STATE_REVOKED",
		5: "TRADE_STATE_USERPAYING",
		6: "TRADE_STATE_PAYERROR",
	}
...
func (TradeState) Descriptor() protoreflect.EnumDescriptor {
	return file_wxpay_proto_enumTypes[0].Descriptor()
}

func (TradeState) Type() protoreflect.EnumType {
	return &file_wxpay_proto_enumTypes[0]
}
...
func (x *WxPayCallbackRsp) GetErrcode() int32 {
	if x != nil {
		return x.Errcode
	}
	return 0
...
func (x *WxPayCallbackRsp) GetErrmsg() string {
	if x != nil {
		return x.Errmsg
	}
	return ""
...
var file_wxpay_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x4d, 0x73, 0x67, 0x22, 0x44, 0x0a, 0x10, 0x57,
	...
	,
	...
	0x61, 0x72, 0x2d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x2f, 0x77, 0x78, 0x70, 0x61,
...
var file_wxpay_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_wxpay_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_wxpay_proto_goTypes = []interface{}{
	(TradeState)(0),          // 0: funstar.wxpay.TradeState
	(*WxPayment)(nil),        // 1: funstar.wxpay.WxPayment
	(*WxPayCallbackReq)(nil), // 2: funstar.wxpay.WxPayCallbackReq
	(*WxPayCallbackRsp)(nil), // 3: funstar.wxpay.WxPayCallbackRsp
}
...
func file_wxpay_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_wxpay_proto_enumTypes,
